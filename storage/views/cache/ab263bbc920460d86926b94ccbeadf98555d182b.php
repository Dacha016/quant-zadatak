    ...
    <div style="margin: 20px auto; max-width: 1000px;" >
        <table style="text-align: center;">
            ...
            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="margin: 0 auto; border: 1px solid black"><a href="/gallery/<?php echo e($row->galleryId); ?>"><?php echo e($row->name); ?></a></td>
                    ...
                    <?php if($row->user_id === $_SESSION["id"] || $_SESSION["role"] !== "user"): ?>
                        <td style="border: 1px solid black">
                            <form action ="#" method="post" class="d-inline-block m-1">
                                <input type="hidden" value="<?php echo e($row->is); ?>" name="adminModeratorUpdate">
