<form 
  ...
  <div class="mb-3 mt-3">
    ...
    for="username" 
    class="form-label"
    style="font-size:18px; margin-left:15px;">Username:</label>
    <input 
    type="username" 
    class="form- control d-block p-2"
    style="width:95%;margin:10px auto; border-radius:10px" id="username"  
    name="username">
  </div>
  <div class="mb-3">
    <label 
    for="password" 
    class="form-label" 
    style="font-size:18px; margin-left:15px;">Password:</label>
    <input 
    type="password" 
    class="form- control d-block p-2"
  ...
  style="border-radius:10px; width:20%;float:right; margin-right:15px">Login</button>
</form>