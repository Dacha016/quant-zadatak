<form action="#" method="post" class="p-2 align-self-center" style="margin:10px auto; margin-top:30Vh; border:black 1px solid;
  ...
  <div class="mb-3 mt-3">
    ...
    <input type="username" class="form- control d-block p-2" style="width:95%;margin:10px auto; border-radius:10px" id="username" name="username">
  </div>
  <div class="mb-3">
